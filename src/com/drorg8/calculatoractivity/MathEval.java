...
//
// Contributions by Carlos GÃ³mez of Asturias, Spain, in the area of unary operators
 ...
 *     '^'       80 / 81     NO_SIDE        Power
 *     'Â±'       60 / 60     RIGHT_SIDE     Unary negation (internal, substituted for '-')
 *     '*'       40 / 40     NO_SIDE        Multiple (conventional computer notation)
 *     'Ã—'       40 / 40     NO_SIDE        Multiple (because it's a Unicode world out there)
 *     'Â·'       40 / 40     NO_SIDE        Multiple (because it's a Unicode world out there)
 *     '('       40 / 40     NO_SIDE        Multiply (implicit due to brackets, e.g "(a)(b)")
 *     '/'       40 / 40     NO_SIDE        Divide (conventional computer notation)
 *     'Ã·'       40 / 40     NO_SIDE        Divide (because it's a Unicode world out there)
